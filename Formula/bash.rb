class Bash < Formula
  ...
  devel do
    url "https://ftp.gnu.org/gnu/bash/bash-5.0-alpha.tar.gz"
    mirror "https://mirrors.ocf.berkeley.edu/gnu/bash/bash-5.0-alpha.tar.gz"
    mirror "https://mirrors.kernel.org/gnu/bash/bash-5.0-alpha.tar.gz"
    mirror "https://ftpmirror.gnu.org/bash/bash-5.0-alpha.tar.gz"
    mirror "https://gnu.cu.be/bash/bash-5.0-alpha.tar.gz"
    mirror "https://mirror.unicorncloud.org/gnu/bash/bash-5.0-alpha.tar.gz"
    sha256 "b1d7ee726af6d060702b1055bb7e40d82715410ea7459ff9d3ac38a1898daf61"
    version "5.0"
  end
